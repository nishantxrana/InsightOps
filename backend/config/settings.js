  ...
  buildConfig() {
    ...
    this.config = {
      ...
      azureDevOps: {
        ...
        personalAccessToken:
          runtime.azureDevOps?.personalAccessToken || defaults.azureDevOps.personalAccessToken,
      ...
      notifications: {
        teamsWebhookUrl:
          runtime.notifications?.teamsWebhookUrl || defaults.notifications.teamsWebhookUrl,
        slackWebhookUrl:
          runtime.notifications?.slackWebhookUrl || defaults.notifications.slackWebhookUrl,
        googleChatWebhookUrl:
          runtime.notifications?.googleChatWebhookUrl ||
          defaults.notifications.googleChatWebhookUrl,
        ...
        googleChatEnabled:
          runtime.notifications?.googleChatEnabled || defaults.notifications.googleChatEnabled,
      ...
      polling: {
        ...
        pullRequestInterval:
          runtime.polling?.pullRequestInterval || defaults.polling.pullRequestInterval,
        overdueCheckInterval:
          runtime.polling?.overdueCheckInterval || defaults.polling.overdueCheckInterval,
      },
