        ...
        {isFailed && (
          <div className="px-6 py-3 bg-muted border-b border-red-200 dark:border-red-800 flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">
              — Review logs and AI analysis below
            </span>
          </div>
        )}
        ...
        <div className="overflow-y-auto flex-1">
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
              ...
              {/* Duration / Reason */}
              <div
                className={`p-3 rounded-lg bg-muted ${isFailed ? "border border-red-400 dark:border-red-700" : ""}`}
              >
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground mb-1">
                  {duration ? (
                ...
                <p
                  className={`font-medium text-sm ${isFailed ? "text-red-700 dark:text-red-300" : "text-foreground"}`}
                >
                  {duration || reason}
                </p>
              </div>
