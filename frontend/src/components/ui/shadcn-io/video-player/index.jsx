...
export const VideoPlayerFullscreenButton = ({ className, ...props }) => (
  <MediaFullscreenButton className={cn("p-2.5", className)} {...props} />
);

export const VideoPlayerPipButton = ({ className, ...props }) => (
  <MediaPipButton className={cn("p-2.5", className)} {...props} />
);

export const VideoPlayerLoadingIndicator = ({ className, ...props }) => (
  <MediaLoadingIndicator
