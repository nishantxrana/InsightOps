...
export const buildReleaseUrl = (
  ...
  if (!organization || !project || !releaseId) {
    console.warn("Missing required parameters for release URL:", {
      organization,
      project,
      releaseId,
    });
...
export const buildWorkItemUrl = (
  ...
  if (!organization || !project || !workItemId) {
    console.warn("Missing required parameters for work item URL:", {
      organization,
      project,
      workItemId,
    });
...
export const buildPipelineUrl = (
  ...
  if (!organization || !project || !buildId) {
    console.warn("Missing required parameters for pipeline URL:", {
      organization,
      project,
      buildId,
    });
...
export const buildPullRequestUrl = (
  ...
  if (!organization || !project || !pullRequestId) {
    console.warn("Missing required parameters for pull request URL:", {
      organization,
      project,
      pullRequestId,
    });
